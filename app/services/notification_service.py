...
class NotificationService:
    ...
    async def send_stream_notification(
        ...
        await self.dispatcher.send_stream_notification(
    ...
    async def _send_push_notifications(
        ...
        await self.dispatcher.push_service.send_push_notifications(
            streamer_name, event_type, details
        )
    ...
    async def _send_external_notification(
        ...
        await self.dispatcher.external_service.send_stream_notification(
            streamer_name, event_type, details
        )
