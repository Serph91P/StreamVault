...
class MetadataService:
    ...
    async def _generate_vtt_chapters(self, stream, events, output_path):
        ...
        try:
            ...
            # Check for events that happened before stream start
            has_pre_stream_events = False
            if stream.started_at:
            ...
            with open(output_path, 'w', encoding='utf-8') as f:
                ...
                for i, event in enumerate(events):
                    ...
                    if stream.started_at:
                        ...
                        # Always ensure end offset is after start offset
                ...
                # Create exact filename match for Plex
