...
export const videoApi = {
    ...
    async getVideoById(streamId) {
        return api.get(`/api/videos/stream/${streamId}`)
    },

    async getVideoChapters(streamId) {
        return api.get(`/api/videos/${streamId}/chapters`)
    },

    getVideoStreamUrl(streamId) {
        return `${api.baseURL}/api/videos/stream/${streamId}`
    },

    getVideoStreamUrlByName(streamerName, filename) {
        return `${api.baseURL}/api/videos/${encodeURIComponent(streamerName)}/${encodeURIComponent(filename)}`
    },

    getVideoDownloadUrl(streamId) {
        return `${api.baseURL}/api/videos/stream/${streamId}?download=true`
    }
}
...
export const streamerApi = {
    ...
    async getStreamChapters(streamerId, streamId) {
        // Use the new video API endpoint for chapters
        return videoApi.getVideoChapters(streamId)
    },
