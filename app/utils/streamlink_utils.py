...
from app.services.logging_service import get_streamlink_log_path
...
def get_streamlink_command(
    ...
    if not log_path:
        log_path = get_streamlink_log_path(streamer_name)
...
def get_streamlink_vod_command(
    ...
    ffmpeg_bin = "ffmpeg"  # Default, should be overridden by environment variable
