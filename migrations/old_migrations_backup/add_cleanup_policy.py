...
def upgrade():
    ...
    try:
        ...
        op.add_column("recording_settings", sa.Column("cleanup_policy", sa.Text, nullable=True))

        # Add cleanup_policy column to streamer_recording_settings table
        op.add_column("streamer_recording_settings", sa.Column("cleanup_policy", sa.Text, nullable=True))
